...
basedecode() {
    command clear 
    figlet Base64 Decoding 
    read -p $'Enter Base64 String Here: ' input 
    echo 
    echo Your Decoded String Is Below :D
    echo 
    command echo "$input" | base64 --decode
    echo 
}
menu 